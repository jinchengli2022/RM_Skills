...
class RobotArmController:
    ...
    def move_one_point(self, point, v=30, block=1):
        ...
        self.robot.set_gripper_pick_on(500, 200, block=block)
        self.movel(point1, v=v, block=block)
        point2 = point[1]+0.10
...
def main():
    ...
    # 向前
    # robot_controller.movel([0.103744, 0.471826, 0.066501, -2.561, -0.567, -0.688], v=30, block=1)
    #  # 复位向上
    # robot_controllr.movel([0.275026, 0.064973, 0.736227, -0.705, 0.292, -1.165], v=30, block=1)

    # 三print(robot_controller.robot.rm_get_current_arm_state())
    ...
    # (0, {'joint': [-38.926998138427734, -66.9280014038086, 126.97699737548828, 19.356000900268555, -2.5880000591278076, 89.29000091552734, -73.46800231933594], 'pose': [-0.209744, 0.40884, 0.217793, -2.561, -0.743, 0.014], 'err': {'err_len': 1, 'err': ['0']}})
