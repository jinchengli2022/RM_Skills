...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Capture one RGB-D frame and select a SAM prompt point.")
    ...
    parser.add_argument("--gripper-width", type=float, default=0.02)
